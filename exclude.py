...
while dog:
    ...
    # 7 NEW LINES - UNIQUE TO CODE 1
    print("Magnetizing rubber ducks")
    print("Uploading dreams to the cloud")
    print("Juggling flamingos")
    print("Flipping pancakes in zero gravity")
    print("Feeding the quantum hamster")
    print("Downloading space-time updates")
    print("Mixing potions of confusion")
